...
/*  Created On : 24-lis-2018 18:40:05 				*/
/*  DBMS       : Oracle 						*/
/* ---------------------------------------------------- */
...
(
	...
	"Popis" NVARCHAR(200) NULL,	-- Popis nebezpeci, zobrazuje jak moc pripadne muze  daneho alergika ohrozit
...
(
	"Adresa" NVARCHAR(100) NULL,	-- Adresa sidla dodavatele
	"Dic" NVARCHAR(20) NULL,	-- Danove identifikacni cislo, pro jednoznacnou identifikaci subjektu
	"E-mail" NVARCHAR(100) NULL,	-- E-mail na dodavatele
	"Ico" NVARCHAR(20) NULL,	-- Unikatni osmimistne idenfikacni cislo pravnicke osoby
	"Nazev" NVARCHAR(100) NOT NULL,
	"Telefon" NVARCHAR(20) NULL,	-- Telefon na dodavatele
...
(
	"Nazev" NVARCHAR(30) NULL,	-- Nazev pro danou surovinu
