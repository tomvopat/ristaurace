...
/*  Created On : 24-lis-2018 18:27:54 				*/
/*  DBMS       : Oracle 						*/
/* ---------------------------------------------------- */
...
(
	...
	"Jmeno" NVARCHAR(50) NOT NULL,	-- Jmeno, na koho ma rezervace zaznamenana
...
CREATE TABLE  "Stul"
(
	"Cislo_stolu" NVARCHAR(5) NOT NULL,	-- Identifikace konkretniho stolu
...
(
	...
	"Mena" NVARCHAR(3) NULL,	-- Mena (CZK/USD/EUR...), ve ktere zakaznik platil
